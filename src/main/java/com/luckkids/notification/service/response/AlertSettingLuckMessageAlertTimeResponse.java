...
public class AlertSettingLuckMessageAlertTimeResponse {
	...
	@Builder
	private AlertSettingLuckMessageAlertTimeResponse(AlertStatus entire, AlertStatus mission, AlertStatus luck,
		AlertStatus friend, AlertStatus notice, LocalTime luckMessageAlertTime) {
		this.entire = entire;
