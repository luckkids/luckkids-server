...
public class AlertSettingResponse {
	...
	@Builder
	private AlertSettingResponse(AlertStatus entire, AlertStatus mission, AlertStatus luck, AlertStatus friend,
		AlertStatus notice, LocalTime luckMessageAlertTime) {
		this.entire = entire;
