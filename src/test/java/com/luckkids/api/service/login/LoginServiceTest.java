...
public class LoginServiceTest extends IntegrationTestSupport {
	...
	void generateJwtToken() throws JsonProcessingException {
		User savedUser = userRepository.save(
			createUser("tkdrl8908@naver.com", "1234", SnsType.NORMAL, SettingStatus.INCOMPLETE));
		...
		LoginGenerateTokenResponse loginGenerateTokenResponse = loginService.refreshJwtToken(
			loginGenerateTokenServiceRequest);

		Optional<RefreshToken> refreshToken = refreshTokenRepository.findByUserIdAndDeviceIdAndRefreshToken(
			savedUser.getId(), "testDeviceId", loginGenerateTokenResponse.getRefreshToken());
