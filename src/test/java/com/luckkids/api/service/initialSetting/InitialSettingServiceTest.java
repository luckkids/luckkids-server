...
public class InitialSettingServiceTest extends IntegrationTestSupport {
	...
	void initialSetting() {
		...
		//when
		InitialSettingResponse initialSettingResponse = initialSettingService.initialSetting(
			initialSettingServiceRequest);
		...
		assertThat(initialSettingCharacterResponse.getNickName()).isEqualTo("럭키즈!!");

		assertThat(initialSettingMissionResponse).hasSize(10)
			.extracting("luckkidsMissionId", "missionType", "missionDescription", "alertStatus", "alertTime")
			.containsExactlyInAnyOrder(
				tuple(1, MissionType.HEALTH, "1시에 운동하기", CHECKED, LocalTime.of(0, 0)),
				tuple(2, MissionType.HEALTH, "2시에 운동하기", CHECKED, LocalTime.of(0, 0)),
				tuple(3, MissionType.HEALTH, "3시에 운동하기", CHECKED, LocalTime.of(0, 0)),
				tuple(4, MissionType.HEALTH, "4시에 운동하기", CHECKED, LocalTime.of(0, 0)),
				tuple(5, MissionType.HEALTH, "5시에 운동하기", CHECKED, LocalTime.of(0, 0)),
				tuple(6, MissionType.HEALTH, "6시에 운동하기", CHECKED, LocalTime.of(0, 0)),
				tuple(7, MissionType.HEALTH, "7시에 운동하기", CHECKED, LocalTime.of(0, 0)),
				tuple(8, MissionType.HEALTH, "8시에 운동하기", CHECKED, LocalTime.of(0, 0)),
				tuple(9, MissionType.HEALTH, "9시에 운동하기", CHECKED, LocalTime.of(0, 0)),
				tuple(10, MissionType.HEALTH, "10시에 운동하기", CHECKED, LocalTime.of(0, 0))
			);
