...
public class PushQueryRepositoryTest extends IntegrationTestSupport {
    ...
    @Autowired
    private PushQueryRepository pushQueryRepository;
    ...
    void findAllNoticeTest(){
        ...
        List<Push> pushList = pushQueryRepository.findAllByAlertType(AlertType.NOTICE);
    ...
    void findAllMissionTest(){
        ...
        List<Push> pushList = pushQueryRepository.findAllByAlertType(AlertType.MISSION);
    ...
    void findAllLuckTest(){
        ...
        List<Push> pushList = pushQueryRepository.findAllByAlertType(AlertType.LUCK);
